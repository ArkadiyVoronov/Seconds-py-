...
def bear_room():
    ...
    print("Медведь закрыл дверь выхода.")
    ...
    while True:
        ...
        if choice == "отобрать мед":
            dead("Медведь посмотел на тебя и ударил лапой по лицу.")
        elif choice == "подразнить медведя" and not bear_moved:
            print("Медведь отошел от двери.")
            print("Вы можете войти в нее. Подразнить медведя или
            войти в дверь?")
            bear_moved = True
...
def cthulhu_room():
    ...
    print("Он смотрит на тебяБ и ты начинаешь сходить с ума.")
