...
# обратите внимание, что используются символы {},
# так как неизвестен тип значения
for i in change:
    print(f"Я получил {i}")

# также мы можем создать списки, начнем с пустого
elements = []

# затем используется функция range()
